...
Raw legal/news data
  ↓
01-ca-nhan/data/landing
  ↓
Task 3 convert markdown
  ↓
01-ca-nhan/data/standardized
  ↓
...
Hiện demo dùng data đã xử lý trong `01-ca-nhan/data/standardized/`:
...
pip install -r 01-ca-nhan/requirements.txt
