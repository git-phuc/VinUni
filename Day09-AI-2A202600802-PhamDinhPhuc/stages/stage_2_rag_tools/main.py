...
QUESTION = (
    "Can an employer terminate a labor contract under Vietnamese labor law, "
    "and what is the statute of limitations for a contract claim?"
)
    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "calculator plus a statute-of-limitations checker. Use the tools provided "
                "to ground your analysis in specific statutes and case law. Always search "
                "the database before answering. If the question asks about a filing deadline "
                "or statute of limitations, call check_statute_of_limitations. "
