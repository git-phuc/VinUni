...
QUESTION = (
    "A supplier committed a breach of contract by failing to deliver custom equipment. "
    "What remedies and important case law should the buyer consider?"
)
...
SYSTEM_PROMPT = (
    ...
    "a comprehensive analysis. For breach-of-contract questions, search the legal database "
    "and use search_case_law to identify relevant precedent. Keep your final answer under "
    "500 words."
)
